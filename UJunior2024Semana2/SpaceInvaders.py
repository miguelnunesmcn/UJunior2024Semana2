...
for i in range(1, 9):  # Assuming 8 frames in explosion sprite sheet
    filename = f'monsterexplosion{i}.png'
...
easteregg = pygame.Vector2(690, 1)

tartaruga = pygame.Vector2(player_pos.x, 660)
tartaruga1 = pygame.Vector2(player_pos.x, 660)

shooting = False
player_lives = 30
monster_bullets = []
tiro_img = pygame.image.load("bullet.png")
monstro_img = pygame.image.load("monster.gif")
nave_img = pygame.image.load('spaceship.png')
amongus_img = pygame.image.load("easteregg.gif")
...
def reset_game():
    ...
    player_pos = pygame.Vector2(screen.get_width() / 2, screen.get_height() / 1.5)
    monsters = create_monsters()
    tartaruga = pygame.Vector2(player_pos.x + 34, 660)
    tartaruga1 = pygame.Vector2(player_pos.x - 38, 660)
    shooting = False
    player_lives = 30
    monster_bullets = []
...
while running:
    if in_menu:
        ...
        screen.blit(amongus_img, easteregg)
